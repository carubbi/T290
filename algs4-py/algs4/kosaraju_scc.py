"""
 *  Execution:    python -m algs4.kosaraju_scc filename.txt
 ...
 *  Runs in O(E + V) time.
 *
 *  % python -m algs4.kosaraju_scc ../dataset/tinyDG.txt
 *  5 strong components
 *  1
 *  0 2 3 4 5
 *  9 10 11 12
 ...
 *  7
 *
 *  % python -m algs4.kosaraju_scc ../dataset/mediumDG.txt
 ...
 *  10
 *
 *  % java -Xss50m KosarajuSharirSCC ../dataset/mediumDG.txt
