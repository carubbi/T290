"""
 *  Execution:    python -m algs4.dijkstra_sp input.txt s
 *  Data files:   ../dataset/tinyEWD.txt
 *                ../dataset/mediumEWD.txt
 *                ../dataset/largeEWD.txt
 *
 *  Dijkstra's algorithm. Computes the shortest path tree.
 *  Assumes all weights are nonnegative.
 *
 *  % python -m algs4.dijkstra_sp ../dataset/tinyEWD.txt 0
 *  0 to 0 (0.00)
 ...
 *
 *  % python -m algs4.dijkstra_sp ../dataset/mediumEWD.txt 0
 *  0 to 0 (0.00)
