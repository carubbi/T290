 ...
 *  Data files:   ../dataset/abra.txt
 *                ../dataset/tinytinyTale.txt
 *                ../dataset/medTale.txt
 *                ../dataset/tale.txt
 *
 *  Compress or expand a binary input stream using the Huffman algorithm.
 *
 *  % python -m algs4.huffman - ../dataset/abra.txt | python -m algs4.binarydump 60
 *  010100000100101000100010010000110100001101010100101010000100
 *  000000000000000000000000000110001111100101101000111110010100
 *  120 bits
 *
 *  % python -m algs4.huffman - ../dataset/abra.txt | python -m algs4.huffman +
 *  ABRACADABRA!
 *
"""
