"""
   Execution:    python -m algs4.separate_chaining_hash_st  input.txt

   Data files:   ../dataset/tinyST.txt

   A symbol table implemented using a separate chaining hash.
   This is the 2-3 version.

   % more ../dataset/tinyST.txt
   S E A R C H E X A M P L E

   % python -m algs4.separate_chaining_hash_st ../dataset/tinyST.txt
   A 8
   C 4
   E 12
   H 5
